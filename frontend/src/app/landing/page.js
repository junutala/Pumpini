...
const COPY = {
  en: {
    ...
    ai_title:'Present the TODAY & Predict the TOMORROW.',
    ai_sub:'Reports only tell you what happened. Pumpini sees tomorrow before it arrives — stop stitching yesterday\'s pieces together.',
  ...
  hi: {
    ...
    ai_title:'आज का हाल सामने। कल का अनुमान पहले से।',
  ...
  ta: {
    ...
    ai_title:'இன்றைக் காட்டும். நாளையைக் கணிக்கும்.',
  ...
  te: {
    ...
    ai_title:'ఈరోజును చూపిస్తుంది. రేపును అంచనా వేస్తుంది.',
  ...
  kn: {
    ...
    ai_title:'ಇಂದಿನದನ್ನು ತೋರಿಸುತ್ತದೆ. ನಾಳೆಯದನ್ನು ಊಹಿಸುತ್ತದೆ.',
  ...
  mr: {
    ...
    ai_title:'आज दाखवतो. उद्याचा अंदाज देतो.',

...
router.post('/credit-adjustment', authenticate, requireStationAccess({ required: true }), requirePerm('corporate.manage'), async (req, res, next) => {
...
router.post('/', authenticate, requireStationAccess({ required: true }), requirePerm('lubes.manage'), async (req, res, next) => {
